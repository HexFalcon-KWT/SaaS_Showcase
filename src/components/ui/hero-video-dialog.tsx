        ...
        {isVideoOpen && (
          ...
          >
            ...
            >
              <button
                onClick={() => setIsVideoOpen(false)}
                className="absolute -right-4 -top-4 z-10 rounded-full bg-background p-2 text-foreground shadow-lg ring-1 ring-border transition-transform hover:scale-110"
              >
                <XIcon className="size-5" />
              </button>
              <div className="relative size-full overflow-hidden rounded-2xl border-2 shadow-2xl">
                <iframe
                  src={videoSrc}
                  className="size-full"
                  allowFullScreen
